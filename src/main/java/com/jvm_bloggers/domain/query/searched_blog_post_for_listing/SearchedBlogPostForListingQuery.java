...
public class SearchedBlogPostForListingQuery {
    ...
    public Traversable<SearchedBlogPostForListing> findByTitleOrTag(String searchPhrase, int page,
                                                                    int pageSize) {
        return blogPostRepository.findApprovedPostsByTagOrTitle(searchPhrase,
                PageRequest.of(page, pageSize)).stream()
